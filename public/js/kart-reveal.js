...
(() => {
  ...
  sketchImg.src = '/assets/images/sketch.webp';
  const realImg = new Image();
  realImg.src = '/assets/images/real.webp';
...
(() => {
  ...
  // Localized button states (EN default, VI when <html lang="vi">)
  const L = {
    en: { submitting: 'Submitting...', sent: 'Application Sent &#10003;', failed: 'Failed &mdash; please try again' },
    vi: { submitting: 'Đang gửi...', sent: 'Đã gửi &#10003;', failed: 'Gửi thất bại &mdash; thử lại' },
  };
  const t = L[document.documentElement.lang] || L.en;
